...
class Clinica extends \Tcmed\Entity\Clinica implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Tcmed\\Entity\\Clinica' . "\0" . 'idClinica', '' . "\0" . 'Tcmed\\Entity\\Clinica' . "\0" . 'razaoSocial', '' . "\0" . 'Tcmed\\Entity\\Clinica' . "\0" . 'fantasiaClinica', '' . "\0" . 'Tcmed\\Entity\\Clinica' . "\0" . 'cnpj', '' . "\0" . 'Tcmed\\Entity\\Clinica' . "\0" . 'createdAt', '' . "\0" . 'Tcmed\\Entity\\Clinica' . "\0" . 'updatedAt', '' . "\0" . 'Tcmed\\Entity\\Clinica' . "\0" . 'status', '' . "\0" . 'Tcmed\\Entity\\Clinica' . "\0" . 'contato', '' . "\0" . 'Tcmed\\Entity\\Clinica' . "\0" . 'endereco');
        }
    ...
    public function setId($idClinica)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setId', array($idClinica));

        return parent::setId($idClinica);
    }

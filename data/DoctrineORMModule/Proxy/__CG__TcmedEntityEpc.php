 ...
 */
class Epc extends \Tcmed\Entity\Epc implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Tcmed\\Entity\\Epc' . "\0" . 'idEpc', '' . "\0" . 'Tcmed\\Entity\\Epc' . "\0" . 'epc', '' . "\0" . 'Tcmed\\Entity\\Epc' . "\0" . 'status', '' . "\0" . 'Tcmed\\Entity\\Epc' . "\0" . 'dtCadastro');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Epc $proxy) {
     ...
     * {@inheritDoc}
     */
    public function getIdEpc()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdEpc();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdEpc', array());

        return parent::getIdEpc();
    }
    ...
    public function getEpc()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEpc', array());

        return parent::getEpc();
    }
     ...
     * {@inheritDoc}
     */
    public function setIdEpc($idEpc)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdEpc', array($idEpc));

        return parent::setIdEpc($idEpc);
    }
    ...
    public function setEpc($epc)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setEpc', array($epc));

        return parent::setEpc($epc);
    }

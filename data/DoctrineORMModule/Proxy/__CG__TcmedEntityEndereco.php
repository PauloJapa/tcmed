 ...
 */
class Endereco extends \Tcmed\Entity\Endereco implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Tcmed\\Entity\\Endereco' . "\0" . 'idEndereco', '' . "\0" . 'Tcmed\\Entity\\Endereco' . "\0" . 'numero', '' . "\0" . 'Tcmed\\Entity\\Endereco' . "\0" . 'complemento', '' . "\0" . 'Tcmed\\Entity\\Endereco' . "\0" . 'status', '' . "\0" . 'Tcmed\\Entity\\Endereco' . "\0" . 'logradouro');
        }

 ...
 */
class TipoLogradouro extends \Tcmed\Entity\TipoLogradouro implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Tcmed\\Entity\\TipoLogradouro' . "\0" . 'idTipologradouro', '' . "\0" . 'Tcmed\\Entity\\TipoLogradouro' . "\0" . 'tipo', '' . "\0" . 'Tcmed\\Entity\\TipoLogradouro' . "\0" . 'status');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TipoLogradouro $proxy) {
    ...
    public function getIdTipologradouro()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdTipologradouro();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdTipologradouro', array());

        return parent::getIdTipologradouro();
    }
    ...
    public function setIdTipologradouro($idTipologradouro)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdTipologradouro', array($idTipologradouro));

        return parent::setIdTipologradouro($idTipologradouro);
    }

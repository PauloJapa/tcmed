 ...
 */
class Contato extends \Tcmed\Entity\Contato implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Tcmed\\Entity\\Contato' . "\0" . 'idContato', '' . "\0" . 'Tcmed\\Entity\\Contato' . "\0" . 'nomeContato', '' . "\0" . 'Tcmed\\Entity\\Contato' . "\0" . 'status', '' . "\0" . 'Tcmed\\Entity\\Contato' . "\0" . 'rg', '' . "\0" . 'Tcmed\\Entity\\Contato' . "\0" . 'cpf', '' . "\0" . 'Tcmed\\Entity\\Contato' . "\0" . 'endereco');
        }

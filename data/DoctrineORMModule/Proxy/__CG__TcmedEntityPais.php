 ...
 */
class Pais extends \Tcmed\Entity\Pais implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Tcmed\\Entity\\Pais' . "\0" . 'idPais', '' . "\0" . 'Tcmed\\Entity\\Pais' . "\0" . 'nomePais', '' . "\0" . 'Tcmed\\Entity\\Pais' . "\0" . 'sigla', '' . "\0" . 'Tcmed\\Entity\\Pais' . "\0" . 'codigo', '' . "\0" . 'Tcmed\\Entity\\Pais' . "\0" . 'status');
        }
    ...
    public function getNomePais()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNomePais', array());

        return parent::getNomePais();
    }
    ...
    public function setNomePais($nomePais)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNomePais', array($nomePais));

        return parent::setNomePais($nomePais);
    }

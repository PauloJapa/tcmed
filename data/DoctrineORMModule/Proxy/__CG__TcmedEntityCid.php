 ...
 */
class Cid extends \Tcmed\Entity\Cid implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Tcmed\\Entity\\Cid' . "\0" . 'idCid', '' . "\0" . 'Tcmed\\Entity\\Cid' . "\0" . 'descricaoCid', '' . "\0" . 'Tcmed\\Entity\\Cid' . "\0" . 'numeroCid', '' . "\0" . 'Tcmed\\Entity\\Cid' . "\0" . 'status', '' . "\0" . 'Tcmed\\Entity\\Cid' . "\0" . 'createdBy', '' . "\0" . 'Tcmed\\Entity\\Cid' . "\0" . 'createdAt', '' . "\0" . 'Tcmed\\Entity\\Cid' . "\0" . 'updatedAt', '' . "\0" . 'Tcmed\\Entity\\Cid' . "\0" . 'updatedBy');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Cid $proxy) {
    ...
    public function getIdCid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdCid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdCid', array());

        return parent::getIdCid();
    }
    ...
    public function getDescricaoCid()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDescricaoCid', array());

        return parent::getDescricaoCid();
    }
    ...
    public function getNumeroCid()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNumeroCid', array());

        return parent::getNumeroCid();
    }
    ...
    public function setIdCid($idCid)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdCid', array($idCid));

        return parent::setIdCid($idCid);
    }
    ...
    public function setId($idCid)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setId', array($idCid));

        return parent::setId($idCid);
    }
    ...
    public function setDescricaoCid($descricaoCid)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDescricaoCid', array($descricaoCid));

        return parent::setDescricaoCid($descricaoCid);
    }
    ...
    public function setNumeroCid($numeroCid)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNumeroCid', array($numeroCid));

        return parent::setNumeroCid($numeroCid);
    }

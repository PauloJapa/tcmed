 ...
 */
class Mensagem extends \Application\Entity\Mensagem implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\Mensagem' . "\0" . 'idMensagem', '' . "\0" . 'Application\\Entity\\Mensagem' . "\0" . 'texto', '' . "\0" . 'Application\\Entity\\Mensagem' . "\0" . 'link');
        }
    ...
    public function getIdMensagem()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdMensagem();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdMensagem', array());

        return parent::getIdMensagem();
    }
    ...
    public function setIdMensagem($idMensagem)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdMensagem', array($idMensagem));

        return parent::setIdMensagem($idMensagem);
    }

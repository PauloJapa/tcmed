 ...
 */
class Country extends \Endereco\Entity\Country implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Endereco\\Entity\\Country' . "\0" . 'iso', '' . "\0" . 'Endereco\\Entity\\Country' . "\0" . 'iso3', '' . "\0" . 'Endereco\\Entity\\Country' . "\0" . 'numcode', '' . "\0" . 'Endereco\\Entity\\Country' . "\0" . 'nome');
        }

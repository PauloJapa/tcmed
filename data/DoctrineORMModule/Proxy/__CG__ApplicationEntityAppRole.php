 ...
 */
class AppRole extends \Application\Entity\AppRole implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\AppRole' . "\0" . 'idRole', '' . "\0" . 'Application\\Entity\\AppRole' . "\0" . 'nome', '' . "\0" . 'Application\\Entity\\AppRole' . "\0" . 'isAdmin', '' . "\0" . 'Application\\Entity\\AppRole' . "\0" . 'createdAt', '' . "\0" . 'Application\\Entity\\AppRole' . "\0" . 'updatedAt', '' . "\0" . 'Application\\Entity\\AppRole' . "\0" . 'parent');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AppRole $proxy) {
    ...
    public function setIdRole($idRole)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdRole', array($idRole));

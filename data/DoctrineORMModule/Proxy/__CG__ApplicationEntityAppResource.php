 ...
 */
class AppResource extends \Application\Entity\AppResource implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\AppResource' . "\0" . 'idResource', '' . "\0" . 'Application\\Entity\\AppResource' . "\0" . 'name', '' . "\0" . 'Application\\Entity\\AppResource' . "\0" . 'createdAt', '' . "\0" . 'Application\\Entity\\AppResource' . "\0" . 'updatedAt');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AppResource $proxy) {
    ...
    public function getIdResource()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdResource();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdResource', array());
    ...
    public function setIdResource($idResource)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdResource', array($idResource));

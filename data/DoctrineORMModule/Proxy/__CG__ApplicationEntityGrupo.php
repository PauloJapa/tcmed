...
class Grupo extends \Application\Entity\Grupo implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\Grupo' . "\0" . 'idGrupo', '' . "\0" . 'Application\\Entity\\Grupo' . "\0" . 'nome', '' . "\0" . 'Application\\Entity\\Grupo' . "\0" . 'statusMsg', '' . "\0" . 'Application\\Entity\\Grupo' . "\0" . 'statusChat', '' . "\0" . 'Application\\Entity\\Grupo' . "\0" . 'status');
        }
    ...
    public function setId($idGrupo)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setId', array($idGrupo));

        return parent::setId($idGrupo);
    }

 ...
 */
class Descricao extends \Tcmed\Entity\Descricao implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Tcmed\\Entity\\Descricao' . "\0" . 'idDescricao', '' . "\0" . 'Tcmed\\Entity\\Descricao' . "\0" . 'descricao', '' . "\0" . 'Tcmed\\Entity\\Descricao' . "\0" . 'status');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Descricao $proxy) {
    ...
    public function getIdDescricao()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdDescricao();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdDescricao', array());

        return parent::getIdDescricao();
    }
    ...
    public function setIdDescricao($idDescricao)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdDescricao', array($idDescricao));

        return parent::setIdDescricao($idDescricao);
    }

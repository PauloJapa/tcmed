 ...
 */
class Risco extends \Tcmed\Entity\Risco implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Tcmed\\Entity\\Risco' . "\0" . 'idRisco', '' . "\0" . 'Tcmed\\Entity\\Risco' . "\0" . 'descricao', '' . "\0" . 'Tcmed\\Entity\\Risco' . "\0" . 'dtInclusao', '' . "\0" . 'Tcmed\\Entity\\Risco' . "\0" . 'status');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Risco $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setId($idRisco)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setId', array($idRisco));

        return parent::setId($idRisco);
    }
    ...
    public function getIdRisco()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdRisco();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdRisco', array());

        return parent::getIdRisco();
    }
    ...
    public function getDtInclusao($obj = false, $full = false)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDtInclusao', array($obj, $full));

        return parent::getDtInclusao($obj, $full);
    }
     ...
     * {@inheritDoc}
     */
    public function setIdRisco($idRisco)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdRisco', array($idRisco));

        return parent::setIdRisco($idRisco);
    }
    ...
    public function setDtInclusao($dtInclusao)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDtInclusao', array($dtInclusao));

        return parent::setDtInclusao($dtInclusao);
    }

 ...
 * EntityEnviado
 *
 * @ORM\Table(name="enviado", indexes={@ORM\Index(name="fk_enviado_user1_idx", columns={"from_id_user"}), @ORM\Index(name="fk_enviado_user2_idx", columns={"to_id_user"}), @ORM\Index(name="fk_enviado_mensagem1_idx", columns={"mensagem_id_mensagem"}), @ORM\Index(name="IDX_D3290C8DAFD2444D", columns={"to_id_grupo"})})
 * @ORM\Entity
 */
class EntityEnviado
{
